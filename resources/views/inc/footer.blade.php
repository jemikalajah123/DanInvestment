...
<footer class="page-footer font-small unique-color-dark">
      ...
      <div class="container">
        ...
        <div class="row py-4 d-flex align-items-center">
          ...
          <div class="col-md-6 col-lg-5 text-center text-md-left mb-4 mb-md-0">
            <h6 class="mb-0" style="color: #3490dc">Get connected with us on social networks!</h6>
          </div>
          <!-- Grid column -->
          ...
          <div class="col-md-6 col-lg-7 text-center text-md-right">
            ...
            <!-- Google +-->
            <a class="gplus-ic" href="https://myaccount.google.com">
    ...
    <div class="container text-center text-md-left mt-5">
      ...
      <div class="row mt-3">
        ...
        <div class="col-md-3 col-lg-2 col-xl-2 mx-auto mb-4" >
          ...
          <hr class="deep-purple accent-2 mb-4 mt-0 d-inline-block mx-auto" style="width: 60px;">
          <p>
            <a style="color: black" href="/dashboard">Your Account</a>
          </p>
          <p>
    ...
    <div class="footer-copyright text-center py-3">© 2020 Copyright:
      <a href="/posts"> dan-investment.com.ng</a>
    </div>
    <!-- Copyright -->
